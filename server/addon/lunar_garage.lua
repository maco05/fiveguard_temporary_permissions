if type(Config.PreconfiguredPermissions) == "table" and Config.PreconfiguredPermissions.LunarGarage == true then
    ...
    AddEventHandler("lunar_garage:enabletemppermissions", function()
        ...
        if Fiveguard and exports[Fiveguard] and type(exports[Fiveguard].SetTempPermission) == "function" then
            exports[Fiveguard]:SetTempPermission(src, "Vehicle", "BypassVehiclePlateChanger", true, false)
        end
    end)
    ...
    AddEventHandler("lunar_garage:disabletemppermissions", function()
        local src = source
        if Fiveguard and exports[Fiveguard] and type(exports[Fiveguard].SetTempPermission) == "function" then
            exports[Fiveguard]:SetTempPermission(src, "Vehicle", "BypassVehiclePlateChanger", false, false)
        end
    end)
end
